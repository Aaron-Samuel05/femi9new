...
export const POSTS: JournalPost[] = [
  /* ------------------------------------------------------------------ 01 */
  {
    ...
    body: [
      ...
      "A new chapter begins. That chapter is Lumi9.",
      "The story goes back to Dr. Gomathi, whose vision and commitment to care became the foundation of the Femi9 journey. Over the years, Femi9 continued to grow and reach more women. A significant new chapter began when leading actress Nayanthara and director Vignesh Shivan joined as co-founders, bringing a shared vision and renewed energy to the brand journey.",
      ...
      "But families grow. And with every growing family comes a new world of little moments, little needs, and a whole new kind of care.",
      "That made us ask: if we understand care for her, can we create something thoughtful for them too?",
      ...
      "A baby doesn't know what a diaper is. But a parent notices everything.",
      ...
      "That understanding became the heart of Lumi9. Because somewhere between a diaper change at 3 a.m. and a first wobbly step, care simply becomes love in practical form.",
      ...
      "Not just softness. Not just protection. But the right balance of comfort, skin-friendly care, breathability and reliable protection. Because when it comes to babies, every detail matters.",
      ...
      "And as babies grow, their needs change too. That's why Lumi9 comes in [sizes designed to grow with your baby](/size-guide) — from NB newborn tape diapers up to 5 kg through to XL baby diaper pants for 12–17 kg.",

      "## A New Standard in Baby Care",
      "Lumi9 isn't simply a new product from Femi9. It is a new expression of the same belief — better care for every stage of life.",
      "> Every small moment a parent almost misses while reaching for a diaper — that's the moment Lumi9 was built to protect.",
      "The softness of a baby's first days. The excitement of their first movements. The joy of their first steps. The countless little moments parents never want to miss. Lumi9 is created to be part of them.",

      "## 2026 — The Journey Expands",
      "In 2026, Femi9 entered a new chapter with the launch of Lumi9 Baby Diapers. A journey that began with caring for women has now expanded to caring for little ones.",
      "From her comfort to their comfort. From women's care to baby care. From one vision to a growing family.",
      ...
      "Many parents comparing options begin with broad searches such as newborn baby diapers, diapers online or best diapers in India. Lumi9 was built to earn a place in that conversation through thoughtful fit, comfort and everyday performance rather than shelf presence alone.",
      `Whichever brand you choose, peace of mind and gentle protection should never feel optional. You can explore the full [Lumi9 baby diaper range](/shop) to find the fit that suits your little one best. For general guidance on baby skin and nappy care, the [NHS has practical, easy-to-follow information](${NHS_NAPPY_RASH}) worth a read, and the [WHO offers broader guidance on early childhood care](${WHO_BREASTFEEDING}).`,

      "## Welcome to Lumi9",
      "Softness they can feel. Care you can trust.",
  ...
  /* ------------------------------------------------------------------ 02 */
  {
    ...
    body: [
      ...
      "Lumi9 is designed without harsh chemicals, reflecting a parent preference for simpler, skin-conscious everyday baby-care choices.",
      ...
      `Every baby's skin is different. Even with a soft, breathable diaper, regular changes, gentle cleansing and a good fit remain important. The [NHS guidance on nappy rash](${NHS_NAPPY_RASH}) recommends changing wet or dirty nappies promptly and keeping the skin clean and dry. The [American Academy of Pediatrics](${AAP}) also emphasizes frequent diaper changes and gentle skin care. If your baby has persistent redness, broken skin, fever, blistering, spreading irritation or you are worried for any reason, speak with a pediatrician or qualified healthcare professional.`,
      ...
      "> Lumi9 by Femi9 is made for those moments — not because a diaper is the biggest part of parenting, but because when something touches your baby every day, the small details deserve to be thoughtfully considered.",
      "Softness. Movement. Absorption. Airflow. Leakage protection. Easier changing. Daytime play. Night-time sleep. That is the everyday comfort Lumi9 is setting out to support — one change, one cuddle and one ordinary Tuesday at a time.",
    ],
    faqs: [
      {
  ...
  /* ------------------------------------------------------------------ 03 */
  {
    ...
    body: [
      ...
      "A baby's diaper still needs to perform its main job: absorb and contain wetness. But comfort also depends on what happens around that absorbent system. That is why breathable diaper construction often focuses on the backsheet, the outer layer of the diaper.",
      ...
      "> Breathability should never be treated as a replacement for regular diaper changes, correct sizing or good skin-care habits. Think of it as one part of a complete diaper-comfort system.",
      ...
      "You cannot say, “This feels warm.” You cannot loosen the waistband. You cannot change your diaper. You simply wriggle, fuss, cry or become restless — and the mom caring for you has to figure out why. That is why seemingly small design details matter.",
      ...
      "**Absorbency** is about how the diaper receives, distributes and holds liquid. **Breathability** is about the diaper's ability to support airflow or vapour movement through appropriate parts of its outer structure.",
      ...
      "You could buy a beautifully designed premium diaper and still have a bad experience if the size is wrong. Too tight? The diaper may create unnecessary pressure or rubbing. Too loose? You may see gaps around the waist or legs that make leaks more likely.",
      ...
      "Their diaper has to move with them. Lumi9 uses a soft stretch waistband designed to support comfortable movement and fit — [find the right diaper size for your baby](/size-guide).",
      ...
      `The [NHS](${NHS_NAPPY_RASH}) recommends changing wet or dirty nappies promptly, keeping the skin clean and dry, ensuring nappies fit properly and allowing diaper-free time when practical. The [American Academy of Pediatrics](${AAP}) also advises frequent diaper changes and gentle skin care.`,
      ...
      "This is why moms searching for **overnight baby diapers** should consider more than maximum absorption. Look for a balance of absorbency, fit, side protection, softness, breathable design and appropriate diaper changes. Always change a soiled diaper promptly, and follow healthcare guidance appropriate to your baby's age and skin needs.",

      "## A Breathable Diaper Is Helpful — but It Is Not the Whole Story",
      "1. **Change wet or soiled diapers regularly.** Do not rely only on maximum absorbency. Your baby's skin still benefits from regular checking and changing.\n2. **Keep the diaper area gently clean.** Use gentle cleaning practices appropriate for your baby's skin. Avoid unnecessary rubbing.\n3. **Allow some diaper-free time.** When practical and safe, a short period without a diaper allows the skin to be exposed directly to air.\n4. **Check the fit.** If you consistently notice strong elastic marks or the diaper appears too tight, review the size.\n5. **Ask for medical advice when needed.** Persistent, severe, spreading, blistering or otherwise concerning irritation should be evaluated by a qualified healthcare professional.",
      ...
      "Lumi9 approaches diaper comfort as a combination of softness + airflow + moisture management + fit + movement + leakage protection + easier changing cues. Not because moms need another complicated baby product. Because they need products where someone has already thought carefully about the small details.",

      "## Final Thoughts: Comfort Is Often Something a Baby Cannot Ask For",
      "One day, your baby will be able to tell you exactly what they want. Water. A toy. Another story. One more hug before bed. Right now, your baby communicates differently. A wiggle. A cry. A restless nap. A sudden smile when something uncomfortable has finally been fixed.",
  ...
  /* ------------------------------------------------------------------ 04 */
  {
    ...
    body: [
      ...
      "No one hands a first-time mom confidence along with the birth certificate. Most moms build it slowly — one feed, one diaper change, one sleepless night and one tiny lesson at a time.",
      "These **newborn baby care tips** are not here to make motherhood feel like another test you must pass. They are here to help you understand the everyday basics: feeding, safe sleep, bathing, umbilical cord care, diaper changes, baby skin, soothing and the moments when you should call a doctor.",
      "> Your baby does not need a perfect mom. Your baby needs a cared-for, informed mom who keeps showing up — and you are already doing that.",

      "## 1. Learn Your Baby Before You Try to Follow Every Rule",
      "In the first few weeks, advice arrives from everywhere. Family members, friends, social media, parenting groups and well-meaning relatives may all tell you the “right” way to feed, burp, bathe, hold or settle your baby. Reliable guidance matters, but so does learning your own baby.",
      "Newborns communicate through small signals: turning toward the breast or bottle, opening the mouth, rooting, bringing hands toward the face, fussing, becoming quiet, stiffening, looking away or crying. Over time, you start recognising what different movements may mean.",
      "That recognition is not instant. It grows with repetition. Instead of expecting yourself to understand every cry on day one, think of the first weeks as getting to know a new person who does not yet speak your language.",

      "## 2. Feeding: Watch the Baby, Not Only the Clock",
      `Newborn feeding is one of the biggest sources of anxiety for first-time moms. [WHO breastfeeding guidance](${WHO_BREASTFEEDING}) recommends breastfeeding within the first hour after birth where possible, exclusive breastfeeding for the first six months, and feeding according to the baby's cues.`,
      `[UNICEF](${UNICEF_PARENTING}) notes that newborns commonly feed very frequently, often around every two to three hours, although individual patterns vary.`,
      "If breastfeeding is painful, your baby is having difficulty latching, you are worried about milk transfer, or feeding is becoming overwhelming, ask for help from your pediatrician, maternity team or a qualified lactation professional. Feeding support is not a sign that you are failing. It is part of newborn care.",

      "## 3. Safe Sleep Is One Area Where Clear Rules Matter",
      `There are many areas of parenting where families can choose what works best. Safe infant sleep is different because the sleep environment affects safety. [American Academy of Pediatrics safe-sleep guidance](${AAP}) recommends placing babies on their backs for every sleep on a firm, flat, non-inclined surface and keeping pillows, loose blankets, bumper pads and stuffed toys out of the baby's sleep space.`,
      "A beautifully decorated cot may look comforting to an adult, but a simpler sleep space is safer for a newborn.",

      "## 4. Your Newborn Does Not Need a Complicated Bath Routine",
      "That first bath can make even a confident adult suddenly feel as if babies are made of glass. They are slippery, tiny and sometimes deeply unimpressed by the whole idea.",
      `[NHS newborn guidance](${NHS_BABY}) explains that plain water is enough for very young newborn skin and recommends gentle washing and careful drying, especially between skin folds. Keep everything you need within reach before you begin, support your baby's head securely, and never leave a baby alone in or near water — even for a moment.`,

      "## 5. Umbilical Cord Care: Keep It Simple",
      "The umbilical cord stump can look intimidating at first, but routine care is usually simple. NHS guidance for caring for a newborn supports keeping the area clean and dry and following the advice given by your maternity team or pediatrician.",
      "If the stump becomes dirty with urine or stool, clean gently with water and pat dry. Do not pull it off; let it separate naturally. Contact a healthcare professional if you notice spreading redness, pus, persistent bleeding, a bad smell, fever or if your baby seems unwell.",

      "## 6. Diaper Changes Become One of Your Most Frequent Care Routines",
      "A first-time mom may change more diapers in the first few weeks than she expected to change in a lifetime. At first, every change feels like a small operation. Soon, your hands remember the routine without your brain having to think about every step.",
      `[NHS diaper-changing guidance](${NHS_BABY}) recommends changing wet or soiled diapers promptly because newborn skin is delicate.`,

      "### How to Put on a Newborn Diaper",
      "1. Wash your hands and prepare the fresh diaper before removing the used one.\n2. Lay your baby on a safe, flat changing surface and keep one hand close to the baby at all times.\n3. Clean the diaper area gently, wiping from front to back.\n4. Pat the skin dry rather than rubbing.\n5. Slide the clean diaper underneath the baby.\n6. Fasten it securely without making the waist or leg area excessively tight.\n7. For a baby whose umbilical stump is still present, follow the diaper design and your healthcare team's advice so the area is not unnecessarily rubbed or covered.",

      "## 7. Choosing Newborn Baby Diapers: Comfort Is More Than Absorbency",
      "The keyword **newborn baby diapers** may sound purely commercial, but the person searching it is often a mom asking a much more human question: “What will feel comfortable on my baby's skin?”",
      ...
      "Lumi9 brings several comfort and moisture-management features together in one diaper system.",
      "• **Aloe Vera-Infused Top Sheet** — designed to support skin smoothening and rash-free comfort for delicate baby skin.\n• **ADL (Acquisition Distribution Layer)** — helps distribute liquid more evenly across the absorbent area.\n• **Advanced SAP Core** — designed to absorb and hold moisture.\n• **Breathable Backsheet** — supports airflow through the outer layer.\n• **Wetness Lock Technology** — helps manage absorbed moisture within the diaper structure.\n• **Double Leakage Barrier** — supports side-leakage protection.\n• **Wetness Indicator** — provides a visible cue that can help moms know when the diaper may need checking.",
      "These are separate functions working together. In particular, the Aloe Vera-infused top sheet and the ADL should not be described as the same feature: Aloe Vera supports skin smoothening and rash-free comfort, while ADL supports liquid distribution.",
      "Lumi9's [newborn size (NB) is designed for babies up to 5 kg](/product/nb).",

      "## 8. Diaper Rash Prevention Starts With the Routine, Not One Product Claim",
      "Newborn skin is delicate, and redness in the diaper area is common. It can be related to prolonged wetness, stool contact, friction, skin sensitivity, fit and other causes. No diaper should be marketed as a guarantee against diaper rash.",
      "Practical newborn diaper-rash prevention includes checking the diaper frequently, changing wet or soiled diapers promptly, cleaning gently, drying the skin carefully, using the correct diaper size and allowing some diaper-free time when practical.",
      `If a rash becomes severe, spreads, blisters, does not improve, or your baby appears unwell, [seek medical advice](${NHS_NAPPY_RASH}).`,

      "## 9. Crying Is Communication, Not a Scorecard for Your Motherhood",
      "There will be evenings when your baby is fed, changed, warm, held and still crying. Those moments can feel personal. They are not.",
      "Newborns cry for many reasons: hunger, tiredness, discomfort, overstimulation, the need for closeness, temperature changes or simply because crying is one of the few communication tools they have.",
      "Check the basics. Hold your baby. Reduce stimulation. Try gentle movement or skin-to-skin contact if appropriate. And if the crying feels unusual, is accompanied by illness symptoms, or your instincts tell you something is wrong, contact your pediatrician. You do not earn motherhood points by handling every difficult moment alone.",

      "## 10. Your Baby's Skin Needs Gentle Care, Not a Shelf Full of Products",
      "Newborn skin is still adapting to life outside the womb. Dryness, peeling and small changes can occur, and not every change requires another product.",
      "Use simple, gentle care. Avoid heavily fragranced or unnecessary products on delicate newborn skin unless advised by a healthcare professional. When choosing clothing, wipes, cleansers or diapers, pay attention to how your own baby's skin responds rather than assuming the same routine works for every baby.",

      "## 11. Learn the Signs That Need Medical Attention",
      "A parenting blog cannot replace a pediatrician, especially during the newborn period.",
      "Seek urgent medical advice if your newborn has difficulty breathing, is unusually difficult to wake, is feeding poorly, has a concerning change in colour, has significantly fewer wet diapers than expected, has repeated vomiting, or simply seems seriously unwell. Fever in a very young baby also deserves prompt medical assessment.",
      "One of the most useful first-time-parent habits is learning this sentence: **“I am worried about my baby and I would like someone to check.”** You never need to apologise for saying it.",

      "## 12. Take Care of the Mom Who Is Taking Care of the Baby",
      "Newborn care advice often talks about the baby as if the mom has stopped being a person. You have not.",
      "You may be healing. You may be sore. You may be running on broken sleep. Feeding may not be going the way you imagined. Your emotions may change by the hour. You may love your baby deeply and still desperately miss ten uninterrupted minutes alone. Both things can be true.",
      "Accept help with food, laundry, errands and household work when you can. Rest in small pockets. Tell someone if you feel persistently low, overwhelmed, frightened, disconnected or unable to cope. A cared-for mom is part of newborn care too.",
      ...
      "A few months from now, some of the things that frighten you today will become automatic. You will change a diaper in the dark. You will know the difference between the hungry cry and the tired cry. You will pack the diaper bag without a checklist. You will pick your baby up and somehow know that something feels different.",
      "But you do not need to be that version of yourself today. Today, it is enough to learn the next small thing. Feed the baby in front of you. Make sleep as safe as you can. Keep the skin clean and comfortable. Change the diaper. Ask the question. Call the doctor when you are worried. Rest when somebody gives you the chance.",
      "> Motherhood is not built in one perfect day. It is built through thousands of ordinary moments in which you keep choosing care.",
      "And somewhere between those feeds, diaper changes, tiny yawns and 3 a.m. cuddles, confidence quietly starts finding you.",
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: "Choose according to the manufacturer's weight range and your baby's actual fit. Lumi9's NB newborn size is designed for babies up to 5 kg. A good fit should sit securely around the waist and legs without excessive gaps or deep pressure marks.",
      },
      {
  ...
  /* ------------------------------------------------------------------ 05 */
  {
    ...
    body: [
      ...
      "If you are asking that question at an hour when the rest of the world seems to be sleeping, you are far from the only mom doing it.",
      "Babies wake at night for many ordinary reasons. Sometimes they are hungry. Sometimes a wet or dirty diaper is uncomfortable. Sometimes they are too hot, too cold, overtired, gassy or simply moving between normal sleep cycles. And sometimes crying can signal pain or illness that deserves medical attention.",
      "This guide will help you work through the common possibilities without making every wake-up feel like a crisis. Because a crying baby is not proof that you are doing motherhood badly. It is communication from someone who does not yet have words.",

      "## First: Night Waking Is Normal for Babies",
      `One of the most reassuring facts a tired mom can hear is that frequent waking does not automatically mean something is wrong. [NHS baby sleep guidance](${NHS_BABY}) explains that newborns commonly wake during the night to feed, and temperature can also disturb sleep. The [American Academy of Pediatrics](${AAP}) also notes that babies do not develop regular sleep cycles immediately and that even older babies may wake during the night.`,
      ...
      "Babies naturally move between lighter and deeper stages of sleep. A baby may stir, make sounds, open the eyes or cry briefly during a transition. Sometimes the baby settles again. Sometimes the baby fully wakes and asks for help returning to sleep.",
      ...
      "An evening full of visitors, bright lights, noise, active play or missed naps can sometimes leave a baby exhausted but unable to settle comfortably. AAP sleep guidance suggests keeping night-time interactions calm and quiet and using daytime for more active interaction.",
      ...
      "There are nights when the diaper is clean, the feed is done, the room is comfortable and nothing obvious is wrong — and your baby still cries the second you put the baby down. That can be exhausting. It can also be developmentally ordinary.",
      "NHS guidance for helping babies sleep notes that young babies commonly fall asleep while being held and then wake when placed in a cot because they want closeness.",
      ...
      "Maybe you have already tried the feed. You changed the diaper. You checked the room. You held the baby until your arms hurt. And the baby still woke again.",
      "It is very easy, in that moment, to turn a baby's crying into a judgment about yourself. “Other moms know what they are doing.” “I should be able to settle my own baby.” “Why can't I fix this?”",
      ...
      "One day, this baby who wakes you by crying will walk into your room and call you by name. One day, the midnight feeds will stop. The diaper bag will disappear. The tiny sleep suit will be packed away, and you may barely remember how many times you walked across the same dark room trying to settle your baby.",
      "But tonight, you are still inside that chapter. So check the simple things. Hunger. Diaper. Temperature. Comfort. Gas. Sleepiness. Closeness. Signs of illness.",
      "And remember that sometimes a baby wakes because babies wake. You do not have to solve motherhood before sunrise. You only have to respond to the little person in front of you, one wake-up at a time.",
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: "Yes. NHS guidance lists a wet or dirty diaper among common reasons babies cry. Babies differ in how quickly wetness disturbs them.",
      },
      {
