...
export async function POST(req: NextRequest) {
  ...
  return handle(async () => {
    ...
    try {
      ...
      // A fully-discounted basket. 400 rather than 409: nothing raced, the
      // basket simply has nothing left to charge, and the message names the
      // discount code so she is not left staring at a gateway error.
