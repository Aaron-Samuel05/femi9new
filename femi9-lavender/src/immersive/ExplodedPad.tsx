...
const LAYERS: Layer[] = [
  { name: 'Organic cotton top sheet', desc: 'Breathable, chlorine-free cotton against skin', color: '#F3ECFA', y0: 0.15, y1: 1.05 },
  { name: 'Mood-lifting anion strip', desc: 'The signature Femi9 negative-ion core', color: '#F0C14E', y0: 0.05, y1: 0.35 },
  { name: 'Biodegradable absorbent core', desc: 'Locks moisture, breaks back down after use', color: '#C0A3E0', y0: -0.05, y1: -0.35 },
  { name: 'Leak-proof breathable backing', desc: 'Stops leaks without trapping heat', color: '#3A2158', y0: -0.15, y1: -1.05 },
]
