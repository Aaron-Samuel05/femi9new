...
const STORAGE_KEY = 'femi9:partner:application'
...
export function Partner() {
  ...
  useEffect(() => {
    try {
      ...
      if (raw) setSaved(JSON.parse(raw) as Application)
    } catch {
      /* localStorage unavailable — treat as no prior application */
    }
  }, [])
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      /* saving is best-effort; still show success so the visitor isn't blocked */
    }
          ...
          {saved ? (
            <div className="pt-success" role="status" aria-live="polite">
              ...
              <p className="pt-success-sub">
                We&apos;ve saved your details on this device, so you&apos;re all set.
                Welcome to the Femi9 family.
              </p>
            </div>
          ) : (
            <form className="pt-form" onSubmit={onSubmit} noValidate>
              ...
              <div className="pt-form-foot">
                <button type="submit" className="btn btn-primary pt-submit">
                  Submit application
                </button>
