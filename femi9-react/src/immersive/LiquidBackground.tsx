...
/**
 * Warm palettes for the liquid — deliberately terracotta / coral / clay over a
 * cream base, moving away from the neon-pink period-brand cliché (spec §1).
 * The palette shifts with cycle mode: calmer & lighter in the active phase,
 * richer & more editorial in the planning phase.
 */
const PALETTES: Record<CycleMode, { base: string; a: string; b: string; c: string }> = {
  // Anchored on the site's original clean cream (#FFFCF4) so the page keeps the
  // colour it had before — the blobs are barely-there warm tints, not tan.
  menstrual: { base: '#FFFCF4', a: '#FBEFDD', b: '#FCEFE8', c: '#FFF8E9' },
  // Planning phase leans a touch warmer/editorial, but still soft peach — never
  // muddy terracotta as a full-page background.
  planning: { base: '#FFFAF2', a: '#F8E5D5', b: '#F6E7DC', c: '#FDF1E1' },
}
