...
(function () {
   ...
   * -------------------------------------------------------------------- */
  var LABELS = [
    { name: 'Soft Top Layer',     desc: 'One-line description goes here.', side: 'left',
      track: [{ f: 60, x: 30, y: 27 }, { f: 75, x: 30, y: 26 }, { f: 90, x: 30, y: 24 }] },
    { name: 'Side Leakage Guard', desc: 'One-line description goes here.', side: 'right',
      track: [{ f: 60, x: 70, y: 31 }, { f: 75, x: 70, y: 30 }, { f: 90, x: 70, y: 28 }] },
    { name: '9 Smart Benefits',   desc: 'One-line description goes here.', side: 'left',
    ...
    { name: 'Air Laid Paper',     desc: 'One-line description goes here.', side: 'right',
      track: [{ f: 60, x: 70, y: 50 }, { f: 75, x: 70, y: 48 }, { f: 90, x: 70, y: 45 }] },
    { name: 'Absorbent Gel',      desc: 'One-line description goes here.', side: 'right',
      track: [{ f: 60, x: 71, y: 60 }, { f: 75, x: 71, y: 59 }, { f: 90, x: 72, y: 58 }] },
    { name: 'Air Laid Paper',     desc: 'One-line description goes here.', side: 'left',
      track: [{ f: 60, x: 27, y: 71 }, { f: 75, x: 27, y: 71 }, { f: 90, x: 27, y: 70 }] },
    { name: 'Cotton Layer',       desc: 'One-line description goes here.', side: 'right',
      track: [{ f: 60, x: 64, y: 71 }, { f: 75, x: 65, y: 69 }, { f: 90, x: 66, y: 67 }] },
    { name: 'Breathable Layer',   desc: 'One-line description goes here.', side: 'left',
  ...
  /* Palette — sampled from the supplied frames so canvas and page merge. */
  var C = {
    field:    '#c3abda',    // frame background lavender
    fieldEdge:'#b89fd2',    // slightly deeper, for the page-side vignette
    ink:      '#3e2c56',    // deep plum text
    inkSoft:  'rgba(62, 44, 86, .66)',
    inkFaint: 'rgba(62, 44, 86, .38)',
    mint:     '#8fd0a6',    // anchor dots, from the printed layer
  ...
  var CSS = '' +
    ...
    '.stage{position:sticky;top:0;height:100vh;height:100svh;' +   /* svh: no jump when mobile chrome collapses */
