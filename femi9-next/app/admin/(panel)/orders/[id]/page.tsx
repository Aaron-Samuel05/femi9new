...
export default function OrderDetailPage(props: { params: Promise<{ id: string }> }) {
  ...
  if (loadError || !order) {
    return (
      <div>
        <Link className="adm-btn adm-btn--ghost adm-btn--sm" href="/admin/orders" style={{ marginBottom: 12 }}>
          ← Orders
        </Link>
        <div className="adm-empty">
  ...
  return (
    <div>
      <Link className="adm-btn adm-btn--ghost adm-btn--sm" href="/admin/orders">
        ← Orders
      </Link>
