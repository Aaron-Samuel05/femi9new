...
**Phase 0 — Workspace.** Create the monorepo, move both apps in unchanged, both
still build and deploy identically. Upgrade femi9 Next 15.5 → 16.3 to match
lumi9. *No functional change.*
